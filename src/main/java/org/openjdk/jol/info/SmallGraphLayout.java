...
public class SmallGraphLayout {
     ...
     * @return object graph
     */
    public static SmallGraphLayout parseInstance(Object... roots) {
        SmallGraphLayout data = new SmallGraphLayout(roots);
        SmallGraphWalker walker = new SmallGraphWalker(roots);
    ...
    public SmallGraphLayout(Object... roots) {
     ...
     */
    public SmallGraphLayout subtract(SmallGraphLayout another) {
        SmallGraphLayout res = new SmallGraphLayout();
     ...
     */
    public SmallGraphLayout add(SmallGraphLayout another) {
        SmallGraphLayout res = new SmallGraphLayout();
        for (Map.Entry<Long, GraphPathRecord> e : addresses.entrySet()) {
            res.addRecord(e.getValue());
        }
